export default {
  ...
  collectionSelector: {
    done: "Artefacto añadido a la colección"
  },
  ...
  museumForm: {
    logo: "Logo",
    shortName: "Nombre corto del museo",
    longName: "Nombre completo del museo",
    front: "Imagen principal de museo",
    city: "Ciudad",
    Update: "Actualizar infomación",
